...
from model.relation_module import RelationModuleBasedOnTFOnFeature, RelationNetwork
...
def main():
    ...
    for epoch in range(EPOCHS):
        ...
        for i, (images, labels) in enumerate(test_loader):
            ...
            support_features, query_features = feature_encoder.parse_feature_map(images, CLASS_NUM, SHOT_NUM_PER_CLASS,
