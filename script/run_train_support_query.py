...
# 20230309 22.11
# 参考原V3的输入方式：support和query分别输入编码器和解码器；
# ========================================导入相关库===========================================
# 导入官方库
import os
import random
...
def main():
    ...
    for task_num, (images, labels) in enumerate(train_loader):
        ...
        # use transformer
        # 计算关系分数；
        relations = relation_network(support=support_features_ext,
                                     query=query_features_ext,
                                     tgt_mask_flag=args.tgt_mask,
                                     memory_mask_flag=args.memory_mask,
                                     mask_type=args.mask_type)  # 输入[75,5,128]    输入出【75,5】
